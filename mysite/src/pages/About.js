        ...
        <div className="flex-wrapper-about">
            <div className="wrapper-left">
                <div style={{marginBottom:'20px'}}>
                    I'm a software graduate from <a className="hyper-link" href='https://uwa.edu.au'>University of Western Australia</a>, my bachelor degree is Engineering Science, specialise in software engineering. I also hold a degree of Master of Professional Engineering specialse in software. My projects are <a className='hyper-link' href="/projects">here</a>.
                </div>
            ...
            <div className="wrapper-right">
                <img src={profileIMG} alt="Profile" style={{width:'250px', height:'260px', marginBottom:'10px'}}/>
                <div className="contact-details">Mobile: 0406194250</div>
                <div className="contact-details">Email: <a className="hyper-link" href={`mailto:${email}`}>tsdaniel0927@gmail.com</a></div>
                <div className="contact-details"> {'>>'} I don't know what to write here...</div>
            </div>
